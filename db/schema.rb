...
ActiveRecord::Schema.define(version: 2020_08_17_230827) do
  ...
  create_table "order_adresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_order_adresses_on_item_id"
  end
  ...
  add_foreign_key "order_adresses", "items"
